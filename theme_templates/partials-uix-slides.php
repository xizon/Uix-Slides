        ...
        $( function() {
            ...
            $( '#uix-slides' ).flexslider( {
                ...
                start: function(slider) {//Fires when the slider loads the first slide
                    ...
                    slider.slides.find( '.uix-slides-homepage-inner' ).css( { 'opacity': 0 } );
                    slider.slides.find( '.uix-slides-homepage-inner' ).eq( 0 ).animate( { 'opacity': 1 }, slider.vars.animationSpeed, slider.vars.easing );			
                    ...
                    slider.slides.find( '.uix-slides-homepage-inner' ).css( { 'opacity': 1 } );	
                },
                ...
                after: function( slider ){//Fires after each slider animation completes
                    ...
                    var currentSlide = slider.slides.find( '.uix-slides-homepage-inner' ).css( { 'opacity': 0, 'display': 'block', 'zIndex': 1 } ).eq( slider.currentSlide ),
                        currentSlideVisible = currentSlide.is(':visible'),
                        sliderSpeed = slider.vars.animationSpeed,
                        sliderEasing = slider.vars.easing;
                
        
                    currentSlide.css( { 'opacity': 0, 'zIndex': 2 } ).animate( { 'opacity': 1 }, sliderSpeed, sliderEasing );
