...
Or, upload the plugin to wordpress, Activate it. (Access the path (/wp-content/plugins/) And upload files there.)</h4>', 'uix-slides' ); ?>
        </p>  
        <p>
           <img src="<?php echo UixSlides::plug_directory(); ?>helper/img/plug.jpg" alt="">
        </p> 
        <p>
           <?php _e( '<h4 class="uix-bg-custom-title">2. You need to create Uix Slides template files in your templates directory. You can create the files on the WordPress admin panel.</h4>', 'uix-slides' ); ?>
     
        </p>  
        <p>
           &nbsp;&nbsp;&nbsp;&nbsp;<a class="button button-primary" href="<?php echo admin_url( "admin.php?page=".UixSlides::HELPER."&tab=temp" ); ?>"><?php _e( 'Create now!', 'uix-slides' ); ?></a>
        ...
        <p>
           <?php _e( '<h4 class="uix-bg-custom-title">3. Create uix slides item and publish slides then.</h4>', 'uix-slides' ); ?>
        </p>  
        <p>
...
>>>>>>> origin/master
        ...
        <p>
           <?php _e( '<h4 class="uix-bg-custom-title">6. The Uix Slides plugin allows users to easily enable a "Customizer Page" to themes. Go to <strong>"Appearance -> Customize"</strong>.</h4>', 'uix-slides' ); ?>
        </p>   
        <p>
